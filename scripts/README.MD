## ALL the scripts in this folder was the first version scripts I created to filter models, but the results are too broad, and I just wanna keep them here for future reference. All of them work well, so please feel free to try and create your own version based on them.
